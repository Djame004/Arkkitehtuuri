...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (waitTimer < 0 && currentState != State.Crouching) currentState = State.Standing;
        ...
        else
        {
            ...
            if (Input.GetKeyDown(KeyCode.Space) && waitTimer <= 0)
            {
        ...
        switch (currentState)
        {
            ...
            case State.Jumping:
                gameObject.transform.localScale = new Vector3(1, 0.33f, 1);
                break;
            ...
            case State.PowerUp:
                gameObject.GetComponent<MeshRenderer>().material = powerUpMat;
                break;
        }
